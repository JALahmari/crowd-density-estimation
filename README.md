...
approach based on **ResNet18** and **PyTorch**.  
The model predicts a continuous density value, which is later mapped into
three crowd density levels: **Low**, **Medium**, and **High**.
...
Video Inference
The trained model supports video-based crowd density estimation:
...
The model was evaluated under multiple visual conditions:
- Low lighting
- Blur
- Low resolution
